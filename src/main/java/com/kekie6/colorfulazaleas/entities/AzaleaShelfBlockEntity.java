...
public class AzaleaShelfBlockEntity extends BlockEntity implements HeldItemContext, ListInventory {
    ...
    public AzaleaShelfBlockEntity(BlockPos pos, BlockState state) {
        super(AzaleaBlockEntityTypes.AZALEA_SHELF_ENTITY, pos, state);
    }
